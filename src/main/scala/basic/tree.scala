...
object tree {
  ...
  def main(args: Array[String]) {
    ...
    //1 构建Spark对象
    val sparkCfg: SparkConf = new SparkConf().setMaster(args(0)).setAppName("DecisionTree")
...
//    println("Learned classification tree model:\n" + model.toDebugString)
    ...
    // 保存模型
    val ModelPath = "C:/Workspace/MySparkApplication/data/module/Decision_Tree_Model"
