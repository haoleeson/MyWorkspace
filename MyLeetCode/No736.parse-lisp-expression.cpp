...
class Solution0 {
    ...
    const int FUNC_LET = 1;
    const int FUNC_ADD = 2;
    const int FUNC_MULT = 3;
    struct partEval {
        int funcType;
        vector<string> params;
        unordered_map<string, int> letMap;
        partEval(int _funcType, vector<string> _params, unordered_map<string, int> _letMap) {
            funcType = _funcType;
            params = _params;
            letMap = _letMap;
        }
...
int main(void) {
    ...
    int res1 = solution.evaluate(expression1);
    cout << res1 << endl;

    string expression2 = "(let x 3 x 2 x)";
    int res2 = solution.evaluate(expression2);
    cout << res2 << endl;

    string expression3 = "(let x 1 y 2 x (add x y) (add x y))";
    int res3 = solution.evaluate(expression3);
    cout << res3 << endl;
