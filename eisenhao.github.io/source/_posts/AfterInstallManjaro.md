...
# 编译环境安装(Gcc, Java, Python)
## 安装gcc make cmake gdb环境
...
## 通过'Add/Remove Software'软件**自动安装JAVA环境**
* 删除系统预装的openjdk
```
...
## ~~安装Python环境~~(系统已经预装Python2.7和Python3.7(默认))
...
### ~~手动安装数据处理必备Numpy模块~~(较麻烦且容易失败，后文介绍用pip3方式安装)
